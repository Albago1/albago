...
export default function MobileBottomNav() {
  ...
  return (
    ...
    >
      <ul className="pointer-events-auto flex items-center gap-1 rounded-full border border-white/10 bg-ink-950/70 px-2 py-1.5 shadow-[0_10px_36px_rgba(0,0,0,0.45)] backdrop-blur-2xl">
        {items.map((item) => {
