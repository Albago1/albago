...
/**
 * "Past" for repost purposes = an event that was real once but isn't live now.
 * Includes completed runs, cancellations, and published rows whose date is gone.
 * Drafts / pending_review / rejected aren't repostable — they never ran.
 */
                      ...
                      {repostable && (
                        <div className="mt-4 flex justify-end">
                          <Link
                            ...
                            className="inline-flex items-center gap-2 rounded-full border border-flame-500/30 bg-flame-500/[0.08] px-4 py-2 text-xs font-semibold text-flame-300 transition hover:border-flame-500/50 hover:bg-flame-500/[0.15] hover:text-flame-200"
                          >
                            <RotateCcw className="h-3.5 w-3.5" />
                            Repost with new date
                          </Link>
                        </div>
                      )}
                    </div>
