...
// Body content stays in English (language of record for privacy policy).
// Section titles + hero + back link are translated via useLanguage().
const SECTIONS: Section[] = [
  ...
  {
    icon: Cookie,
    titleKey: 'privacy_section_cookies_title',
    body: [
  ...
  {
    icon: Mail,
    titleKey: 'privacy_section_contact_title',
    body: [
      ...
      <section className="relative overflow-hidden px-4 pb-12 pt-32">
        ...
        <div className="relative z-10 mx-auto max-w-3xl">
          ...
          <h1 className="display-text mt-5 text-5xl leading-[0.95] tracking-tight sm:text-7xl">
            {t('privacy_title_pre')}{' '}
            <span className="italic text-flame-400">{t('privacy_title_emph')}</span>
          </h1>
          ...
          <p className="mt-3 text-xs uppercase tracking-[0.18em] text-white/35">
            {t('privacy_last_updated')} · {LAST_UPDATED}
          </p>
        </div>
      </section>
